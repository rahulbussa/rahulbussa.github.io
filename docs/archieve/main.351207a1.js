...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"js/darkMode.mjs":[function(require,module,exports) {
"use strict";
...
var darkMode = function darkMode() {
  var darkModeCheck = document.getElementById('night-light-checkbox');

  if (darkModeCheck) {
    darkModeCheck.addEventListener('click', function () {
      darkModeCheck.checked ? document.body.classList.add('dark') : document.body.classList.remove('dark');
    });
  }
};
...
(0, _darkMode.default)();
},{"./darkMode":"js/darkMode.mjs"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
